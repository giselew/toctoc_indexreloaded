...
';
	...
	public function htmlFoldMeta($bufferin) {
		$bufferintags = array();
	 ...
	 * @param	string		$bufferin: orhiginal HTML
	 ...
	 * @param	[type]		$checkpatharr: ...
	 * @param	[type]		$countcheckpatharr: ...
